...
from entities.mixins import Fillable, Clicking
from entities.htmlelement import HtmlElement
from utils.helpers import random_value_from_list_not_contains_value
...
class Image(Clicking, HtmlElement):
    ...
    def source(self):
        ...
        """
        return self._web_element.get_attribute('scr')


class Link(Clicking, HtmlElement):
    def get_href(self):
        return self._web_element.get_attribute('href')
