import entities.wait as wait
from rf_libs import get_driver, get_config
...
class HtmlElement(object):
    ...
    def __init__(self, locator=None, waiter=wait.until_html_element_visible, timeout=wait_timeout, web_element=None):
