...
from core.entities.errors import ConfigurationError
...
class BrowsersSection(IConfigSection):
    ...
    @property
    def version(self):
        return self._get_current_browser_value('version', default=0.1)
...
class ProjectSection(IConfigSection):
    ...
    def browser_name(self):
        if self._browser_name is None:
            self._browser_name = ConfigLoader.get_rf_var(_BROWSER_NAME_VAR,
